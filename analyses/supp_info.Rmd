...
```{r figure-s1, fig.width=5, fig.height=4, fig.cap=s1_caption, fig.scap=s1_caption_short}
...
```{r fig2-with-absolutes, fig.width=6, fig.height=5, fig.cap=fig2_abs_caption, fig.scap=fig2_abs_caption_short}
...
```{r start-not-at-equilibrium, fig.width=6, fig.height=6.75, fig.cap=nae_caption, fig.scap=nae_caption_short}
...
```{r vary-iI-muI-timeseries, fig.width=6, fig.height=5.5, fig.cap=vain_ts_caption, fig.scap=vain_ts_caption_short}
...
```{r vary-iI-muI-equil, fig.width=6, fig.height=4.5, fig.cap=vain_equil_caption, fig.scap=vain_equil_caption_short}
...
nohv_fig3_caption <- "Time series of proportional changes in N content for
                      detritivore and herbivore pools with low and high
                      predator exploitation of
...
nohv_fig3_caption_short <- "Time series of N content in response to a midge pulse, with
                            varying midge exploitation and with herbivores or 
                            detritivores removed" %>% 
    cc()
```



```{r no-H-V-fig3, fig.width=6, fig.height=6.5, fig.cap=nohv_fig3_caption, fig.scap=nohv_fig3_caption_short}
...
nohv_fig3_plot <- function(.H, .V, 
    ...
    .title <- case_when(.H == 0 & .V == 1 ~ "No herbivores",
                        ...
                        .H == 1 & .V == 1 ~ "Herbivores and detritivores present",
                        TRUE ~ "ERROR")
...
```{r no-H-V-fig4, fig.width=6, fig.height=6.5, fig.cap=nohv_fig4_caption, fig.scap=nohv_fig4_caption_short}
...
```{r M-to-one-pool-fig5, fig.width=6.5, fig.height=7.5, fig.cap=mtop_fig5_caption, fig.scap=mtop_fig5_caption_short}
...
To determine the stability of the equilibrium state (using values from Table 1),
we used the `deriv` function in R to numerically compute the Jacobian matrix:

\begin{align*}
\begin{pmatrix}
    \frac{\partial I}{\partial I} & \frac{\partial I}{\partial D} & 
        \frac{\partial I}{\partial P} & \frac{\partial I}{\partial V} &
        \frac{\partial I}{\partial H} & \frac{\partial I}{\partial X} \\[1.5ex]
    \frac{\partial D}{\partial I} & \frac{\partial D}{\partial D} & 
        \frac{\partial D}{\partial P} & \frac{\partial D}{\partial V} &
        \frac{\partial D}{\partial H} & \frac{\partial D}{\partial X} \\[1.5ex]
    \frac{\partial P}{\partial I} & \frac{\partial P}{\partial D} & 
        \frac{\partial P}{\partial P} & \frac{\partial P}{\partial V} &
        \frac{\partial P}{\partial H} & \frac{\partial P}{\partial X} \\[1.5ex]
    \frac{\partial V}{\partial I} & \frac{\partial V}{\partial D} & 
        \frac{\partial V}{\partial P} & \frac{\partial V}{\partial V} &
        \frac{\partial V}{\partial H} & \frac{\partial V}{\partial X} \\[1.5ex]
    \frac{\partial H}{\partial I} & \frac{\partial H}{\partial D} & 
        \frac{\partial H}{\partial P} & \frac{\partial H}{\partial V} &
        \frac{\partial H}{\partial H} & \frac{\partial H}{\partial X} \\[1.5ex]
    \frac{\partial X}{\partial I} & \frac{\partial X}{\partial D} & 
        \frac{\partial X}{\partial P} & \frac{\partial X}{\partial V} &
        \frac{\partial X}{\partial H} & \frac{\partial X}{\partial X}
\end{pmatrix}
\text{.}
\end{align*}
...
oscillatory behavior in the approach to equilibrium (which we see in the simulations
in Fig. \ref{fig:start-not-at-equilibrium}).
