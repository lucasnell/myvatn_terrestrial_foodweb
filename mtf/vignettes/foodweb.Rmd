---
title: "Modeling foodweb response to midge input in Mytvan"
author: "Tanjona Ramiadantsoa"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Modeling foodweb response to midge input in Mytvan}
...
```{r model_pars, echo = FALSE}
mpd_df <- rbind(cbind("`t = 0`", "343000", "114000", "4300", "81", "24", "13", "??"),
      cbind("`m`", "??", "??", "??", "??", "??", "??", "??"),
      cbind("`a`", "N.A.", "??", "??", "??", "??", "??", "N.A."),
	  cbind("`h`", "N.A.", "??", "N.A.", "??", "??", "??", "N.A."),
	  cbind("`i`", "??", "N.A.", "N.A.", "N.A.", "N.A.", "N.A.", "??"),
	  cbind("`K`", "N.A.", "N.A.", "??", "N.A.", "N.A.", "N.A.", "N.A.")) %>% 
    as_data_frame()
colnames(mpd_df) <- c("", "Nitrogen (N)", "Detritus(D)", "Plants (P)",
                      "Detrivores (V)", "Herbivores (H)", "Predators (R)",
                      "Midge (M)")
mpd_df %>% 
