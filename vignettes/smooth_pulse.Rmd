...
$$
where $t$ is time, $\beta$ is the maximum value of the pulse, $\omega$ is the width of the pulse, $r$ is the period of the pulse expressed in units of $1.5 \times\omega$ (so the pulses don't overlap), and $\delta$ sets the mid point of the first pulse in units of $\omega$. Both $\alpha$ and $r$ control the smoothness of the pulse. However, when $\alpha$ is sufficiently high the pulse will allows be rectangular. 
